...
if __name__ == "__main__":
    ...
    text_clf = Pipeline([
        ('vect', TfidfVectorizer(ngram_range=(1, 2), max_df=0.1)),
        ('clf', SVC(kernel='rbf', gamma=0.01, C=500))
        ])

    metrics_out = '/home/gregor/ipyServer/movie_review/output/metrics_rbfsvm.out'
    kaggle_test_out = '/home/gregor/ipyServer/movie_review/output/kaggle_test_02_rbfsvm.csv'
