...
#################################################################################
    ...
    outfile.write("Org. shape: " + str(X_train.get_shape) + '\n')
    ...
    outfile.write("Reduced Shape: " + str(X_train.get_shape) + '\n')

    text_clf.fit(X_train.toarray(), target_train)

    # predict the outcome on the traing test and store it in target_perdicted
    target_perdicted = text_clf.predict(X_test.toarray())
    score = text_clf.score(X_test.toarray(), target_test)
...
###############################################################################
    ...
    outfile.write("Org. shape kaggle test: " + str(X_train.get_shape) + '\n')
    ...
    X_test = ch2.transform(X_test)
    outfile.write("Reduced Shape kaggle test: " + str(X_train.get_shape) + '\n')
    ...
    print(len(target_perdicted))
    print(target_perdicted)
